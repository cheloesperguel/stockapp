...
public class ClienteDAO {
	...
	public static boolean save(Cliente cliente) throws PersistentException {
		try {
			ConcexionPersistenteManager.instance().saveObject(cliente);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(Cliente cliente) throws PersistentException {
		try {
			ConcexionPersistenteManager.instance().deleteObject(cliente);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteAndDissociate(Cliente cliente)throws PersistentException {
		try {
			Factura[] lFacturas = cliente.factura.toArray();
	...
	public static boolean refresh(Cliente cliente) throws PersistentException {
		try {
			ConcexionPersistenteManager.instance().getSession().refresh(cliente);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(Cliente cliente) throws PersistentException {
		try {
			ConcexionPersistenteManager.instance().getSession().evict(cliente);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
