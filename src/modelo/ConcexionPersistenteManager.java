...
public class ConcexionPersistenteManager extends PersistentManager {
	private static final String PROJECT_NAME = "Stockapp";
	...
	private ConcexionPersistenteManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new ConcexionPersistenteManager();
		}
